package shopifyApplication.util;
...
public class Web {
    ...
    private static Method findMethod(Class<?> clazz, String s) {
        ...
        for (Method method : methods) {
            ...
            !method.getParameterTypes()[0].getPackageName().startsWith("not-needed in this app")) {
                return method;
            }
        }
    ...
    public String select(String model, String displayProperty, Object selectedId, boolean includeEmpty) throws Exception {
        ...
        Class<?> clazz = Class.forName("shopifyApplication.model." + model);
